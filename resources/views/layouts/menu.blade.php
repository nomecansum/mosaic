                    ...
                    <li>
                        ...
                        <!--Submenu-->
                                    <ul class="collapse">
                                        ...
                                        @if(checkPermissions(['Bitacora'],['R']))<li class="nav-item"><a  class="nav-link" href="{{ url('bitacoras') }}">
                                            <i class="nav-icon fab fa-stack-exchange"></i><p><span>Bitacora</span></p></a></li>@endif

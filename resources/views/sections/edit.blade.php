...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{url('/users')}}">Secciones</a></li>
        <li class="breadcrumb-item active">Editar seccion {{ !empty($sections->name) ? $sections->name : '' }}</li>
    </ol>
@endsection
...
<div class="row" style="margin-top: 10px">
    ...
    <div class="col-md-1 text-right">
        <div class="btn-group btn-group-sm pull-right" role="group" style="margin-right: 20px;">
            <a href="{{ route('section.index') }}" class="btn btn-primary" title="Listado">

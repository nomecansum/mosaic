...
class ClienteService
{
    ...
    public function validar_request($r,$metodo_notif){
        $validator = Validator::make($r->all(), [
            ...
            'cod_sistema' => ['int', Rule::unique('cug_sistema','COD_SISTEMA')->ignore($r->id, 'id_cliente')]
    ...
    public function delete($id){
        ...
        $empleados_cliente = empleados::where('id_cliente',$id);
        ...
        //DB::table('cug_centros')->where('id_cliente',$id)->delete();
        //DB::table('cug_empleados')->where('id_cliente',$id)->delete();
        //DB::table('cug_colectivos')->where('id_cliente',$id)->delete();
        //DB::table('cug_clientes')->where('id_cliente',$id)->delete();
        return true;
    }
    ...
    public function insertar_sistema($r, $id){
        ...
        if (isset($r->cod_sistema))
        {
            ...
            $sistema = sistemas::where('id_cliente',$id)->first();
            if($sistema===null)
...
*/
    ...
    public function add_a_supracliente($id,$r){
        ...
        DB::table('cug_usuarios')->where('id_cliente',$r->cod_supracliente)->update([
